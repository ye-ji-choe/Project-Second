...
public class NutRobotSequenceTask : Task
{
    ...
    override protected void Program()
    {
        ...
        this.Offset(_targets[2], new Vector3(150f, 0, 0), defaultSpeed);
        this.Offset(_targets[2], new Vector3(0, 0f, 0f), defaultSpeed);
        this.Offset(_targets[2], new Vector3(150f, 0, 0), defaultSpeed);

        this.Log("작업 위치 3번 이동 (첫 번째 볼트 체결)");
        this.Offset(_targets[3], new Vector3(150f, 0, 0), defaultSpeed);
        ...
        this.Offset(_targets[4], new Vector3(150f, 0, 0), defaultSpeed);
        ...
        this.Offset(_targets[5], new Vector3(150f, 0, 0), defaultSpeed);
        ...
        this.Offset(_targets[6], new Vector3(150f, 0, 0), defaultSpeed);
