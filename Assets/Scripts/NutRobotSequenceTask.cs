...
public class NutRobotSequenceTask : Task
{
    ...
    override protected void Program()
    {
        ...
        this.Offset(_targets[4], new Vector3(-100f, 0, 0), defaultSpeed);
        ...
        this.Offset(_targets[5], new Vector3(-100f, 0, 0), defaultSpeed);
        ...
        this.Offset(_targets[6], new Vector3(-100f, 0, 0), defaultSpeed);
